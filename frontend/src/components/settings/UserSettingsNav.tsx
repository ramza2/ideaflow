...
export function UserSettingsNav() {
  ...
  const base = currentWorkspace ? `/w/${currentWorkspace.id}/settings` : "";

  return (
    <div className="bg-white border-b border-[rgba(0,0,0,0.07)]">
      <div className="px-4 sm:px-8 pt-5 pb-0">
        <h1 className="text-xl font-bold text-[#111118]">설정</h1>
        <p className="text-sm text-[#6b6b80] mt-1 mb-4">계정 및 보안</p>
